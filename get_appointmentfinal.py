...
class Ui_Get_Appointment(object):
    ...
    def setupUi(self, Get_Appointment):
        ...
        self.get_busy_doctor_time() #all busy time
        self.get_avalable_doctor_time() #all avalable time
    ...
    def retranslateUi(self, Get_Appointment):
        ...
        self.label_5.setText(_translate("Get_Appointment", "سال"))
...
if __name__ == "__main__":
    ...
    ui = Ui_Get_Appointment("09175606163","1","q")
