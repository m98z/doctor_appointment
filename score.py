...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.appointment_label.setGeometry(QtCore.QRect(230, 79, 161, 211))
        ...
        self.lineEdit.setGeometry(QtCore.QRect(151, 148, 321, 20))
        self.lineEdit.setObjectName("lineEdit")
        self.pushButton = QtWidgets.QPushButton(self.tab_3)
        self.pushButton.setGeometry(QtCore.QRect(240, 210, 131, 21))
        ...
        self.list_healthcare_2 = QtWidgets.QListView(self.tab)
        self.list_healthcare_2.setGeometry(QtCore.QRect(10, 50, 271, 301))
        self.list_healthcare_2.setObjectName("list_healthcare_2")
        self.selected_doctor_2 = QtWidgets.QLabel(self.tab)
        self.selected_doctor_2.setGeometry(QtCore.QRect(310, 230, 259, 25))
        self.selected_doctor_2.setText("")
        self.selected_doctor_2.setObjectName("selected_doctor_2")
        self.profile_3 = QtWidgets.QPushButton(self.tab)
        self.profile_3.setGeometry(QtCore.QRect(310, 330, 257, 17))
        ...
        self.appointment_3 = QtWidgets.QPushButton(self.tab)
        self.appointment_3.setGeometry(QtCore.QRect(310, 310, 257, 17))
        self.appointment_3.setObjectName("appointment_3")
        self.appointment_4 = QtWidgets.QPushButton(self.tab)
        self.appointment_4.setGeometry(QtCore.QRect(310, 270, 257, 17))
        self.appointment_4.setObjectName("appointment_4")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_34.setText(_translate("MainWindow", "امتیاز دهی به پزشک"))
        self.score_clicked.setText(_translate("MainWindow", "تایید امتیاز"))
